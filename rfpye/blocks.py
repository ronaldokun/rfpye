...
__all__ = ['BaseBlock', 'TimedNonSpectral', 'TimedSpectral', 'TimedVersion5', 'Dtype3', 'Dtype4', 'Dtype5', 'DType6',
           'Dtype7', 'Dtype8', 'DType20', 'DType21', 'Dtype22', 'Dtype23', 'DType24', 'DType40', 'DType41', 'DType42',
           'DType51', 'Dtype60', 'Dtype61', 'Dtype62', 'DType63', 'DType64', 'DType65', 'DType66', 'DType67', 'DType68',
           'DType69', 'MAIN_BLOCKS']
...
class Dtype60(GetAttr):
    ...
    def freqexp(self)-> int:
        return bin2int(self.data[20])
    @cached
    def antno(self)-> int:
        return bin2int(self.data[21])
    @cached
    def gerror(self)-> int:
        return bin2int(self.data[22])
    @cached
    def gflags(self)-> int:
        return self.data[23]
    @cached
...
class Dtype62(GetAttr):
    def __init__(self, block: BaseBlock) -> None:
        self.default = block
    @cached
    def walldate(self)-> tuple:
        "F1 = (4 bytes) Wall clock date and time in seconds since 1/1/1970"
        date = L(self.data[:4])
        date[2] += 2000
        return date
    @cached
    def walltime(self)-> tuple:
        return L(self.data[4:8])
    @cached
    def wallnano(self)-> int:
        return bin2int(self.data[8:12], False)
