...
__all__ = ['custom_theme', 'console', 'BYTES_HEADER', 'DATA_BLOCK_HEADER', 'CHECKSUM', 'ENDMARKER', 'LEN_MARKER',
           'EXCLUDE_ATTRS', 'DICT_PROCESSING', 'DICT_UNIT', 'TUNING_BLOCK', 'BYTES_TIMED', 'BYTES_TIMED_NE', 'BYTES_6',
           'BYTES_20', 'BYTES_21', 'BYTES_24', 'BYTES_40', 'BYTES_41', 'BYTES_42', 'BYTES_51', 'BYTES_63', 'BYTES_64',
           'BYTES_65', 'BYTES_V5', 'BYTES_66', 'BYTES_67', 'KEY_ATTRS', 'META', 'LEVELS', 'BLOCK_SIZE', 'TIMED_BLOCKS',
           'SPECTRAL_BLOCKS', 'UNCOMPRESSED', 'COMPRESSED', 'GPS_BLOCK', 'BLOCK_ATTRS', 'custom_theme', 'console',
           'BYTES_HEADER', 'DATA_BLOCK_HEADER', 'CHECKSUM', 'ENDMARKER', 'LEN_MARKER', 'EXCLUDE_ATTRS',
           ...
           'BYTES_V5', 'BYTES_66', 'BYTES_67', 'KEY_ATTRS', 'META', 'LEVELS', 'BLOCK_SIZE', 'TIMED_BLOCKS',
           'SPECTRAL_BLOCKS', 'UNCOMPRESSED', 'COMPRESSED', 'GPS_BLOCK', 'BLOCK_ATTRS']
...
# Cell
KEY_ATTRS = {21: ( "hostname", "method", 'unit_info', 'file_number'),
             24: ("group_id", 'text'),
             40: ('gps_status',),
             41: ('identifier',),
             42: ('identifier',),
    63: ('type', 'thread_id', 'description', 'start_mega', 'stop_mega', 'unit', 'ndata', 'bw', 'processing', 'antenna_id'),
    64: ('type', 'thread_id', 'description', 'start_mega', 'stop_mega', 'unit', 'ndata', 'bw', 'processing', 'antenna_id'),
    67: ('type', 'thread_id', 'description', 'start_mega', 'stop_mega', 'unit', 'ndata', 'bw', 'processing', 'antenna_id'),
    68: ('type', 'thread_id', 'description', 'start_mega', 'stop_mega', 'unit', 'ndata', 'bw', 'processing', 'antenna_id'),
}
