...
__all__ = ['parse_bin', 'evaluate_checksum', 'BaseBlock', 'byte2base_block', 'create_block', 'keys_from_blocks',
           'CrfsGPS', 'CrfsSpectrum', 'classify_blocks', 'parse_bin', 'evaluate_checksum', 'BaseBlock',
           'byte2base_block', 'create_block', 'keys_from_blocks', 'CrfsGPS', 'CrfsSpectrum', 'classify_blocks']
...
class CrfsSpectrum(GetAttr):
    ...
    def __str__(self):
        return f'Blocks of Type : {self.type}, Thread_id: {self.thread_id} and Span {self.start_mega} MHz - {self.stop_mega} MHz'
