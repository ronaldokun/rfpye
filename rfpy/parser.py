...
__all__ = ['path_type', 'bin_val', 'bytes_encoded', 'datetime_object', 'get_files', 'parse_bin', 'classify_blocks',
           'extract_block_levels', 'meta2df', 'extract_metadata', 'export_meta']
...
# Cell
def extract_metadata(map_blocks: Mapping[int,L], full_data: bool = False)->pd.DataFrame:
...
# Cell
def export_meta(meta_item: Tuple[Tuple, pd.DataFrame], saida: Union[str, Path], ext: str = None)->Union[None, pd.DataFrame]:
