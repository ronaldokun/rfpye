        ...
        with Progress() as progress:
            ...
            if meta:
                ...
                if not lista:
                    ...
                    for file in bins:
                        progress.print(f'[cyan]Extraindo Metadados do arquivo {file.name}')
            ...
            if levels:
                if ext == '.csv':
                    ...
                    if not lista:
                        erro_novo = True
                        console.print(":zzz: Nenhum arquivo novo de níveis espectrais a processar, use --substituir no \
                        console ou substituir=True na chamada caso queira reprocessar os bins e sobrepôr os arquivos existentes :point_up:")
                    else:
